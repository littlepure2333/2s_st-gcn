...
from feeder.feeder_hrnet import Feeder_hrnet
...
def gendata(
    ...
    sample_name = feeder.sample_name  # sample_name i.e.'HxGk6WDkOzk.npy'
    sample_label = []
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='data/hrnet')
    parser.add_argument(
        '--out_folder', default='data/hrnet')
    arg = parser.parse_args()

    part = ['train', 'val']
    for p in part:
        data_path = '{}/hrnet_{}'.format(arg.data_path, p)
        label_path = '{}/hrnet_{}_label.json'.format(arg.data_path, p)
        data_out_path = '{}/{}_data.npy'.format(arg.out_folder, p)
        label_out_path = '{}/{}_label.pkl'.format(arg.out_folder, p)

        if not os.path.exists(arg.out_folder):
            os.makedirs(arg.out_folder)
        print("generating {} data...".format(p))
